...
{
    public partial class frmPartyManagement : Form
    {
        public frmPartyManagement()
        {
            InitializeComponent();
        }


        private void frmPartyManagement_Load(object sender, EventArgs e)
        {
            List<CharacterDTO> characters = CharacterDAC.GetCharactersInParty(ContextManager.Current.ActiveAccountID);
        ...
        {
            new frmCreateCharacter().ShowDialog();
        }
